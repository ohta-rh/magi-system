...
> **Note:** This file is a human-readable reference for the output format. The authoritative runtime source for output formatting is `plugins/magi/agents/magi-core.md`, which MAGI Core uses during synthesis. If the two diverge, `magi-core.md` takes precedence.
