...
A Claude Code custom skill that implements the MAGI supercomputer council from Neon Genesis Evangelion for multi-dimensional engineering decision-making.

## Project Structure

```
SKILL.md              — Main skill definition (entry point for /magi command)
agents/
...
- `SKILL.md` is the orchestrator — it spawns three agents in parallel, collects results, and synthesizes the final verdict
